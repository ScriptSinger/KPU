        ...
        <div class="panel @if ($isClearedEntry) panel-danger @else panel-default @endif">
            <div class="{{ $containerClass }} @if ($isClearedEntry) panel-danger @else panel-default @endif">
                <div
                    ...
                    {!! trans('LaravelLogger::laravel-logger.drilldown.title', ['id' => $activity->id]) !!}
                    <a href="@if ($isClearedEntry) {{ route('cleared') }} @else {{ route('activity') }} @endif"
                        class="btn @if ($isClearedEntry) btn-default @else btn-info @endif btn-sm pull-right">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <dl class="dl-horizontal">
                                                ...
                                                <dd>
                                                    <a
                                                        href="@if ($activity->route != '/') / @endif{{ $activity->route }}">
                                                        {{ $activity->route }}
                                                    </a>
                                                </dd>
                                            ...
                                            <dl class="dl-horizontal">
                                                ...
                                                @if ($userDetails)
                                                        ...
                                                        @foreach ($userDetails->roles as $user_role)
                                                            ...
                                                            <dd>
                                                                <span class="badge badge-{{ $labelClass }}">
                                                                    {{ $user_role->name }} - {!! trans('LaravelLogger::laravel-logger.drilldown.labels.userLevel') !!}
                                                                    {{ $user_role->level }}
                                                                </span>
                                                            </dd>
                                                        @endforeach
                                                    ...
                                                    @if ($userDetails->last_name || $userDetails->first_name)
                                                        ...
                                                        <dd>{{ $userDetails->last_name }}, {{ $userDetails->first_name }}
                                                        </dd>
                                                    @endif
